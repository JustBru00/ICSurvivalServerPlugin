...
public class Reference {
	...
	public static final String inLimboMessage = "Hey {MEMBER_NAME},\r\n"
			...
			+ "\r\n"
			+ "If you don't send one of the admins a message, your membership in The Introvert's Cove will end with your automatic retirement 14 days from now. You will then have to go through the entire interview process just like a brand new player if you wish to come back and join us again.\r\n"
			+ "\r\n"
